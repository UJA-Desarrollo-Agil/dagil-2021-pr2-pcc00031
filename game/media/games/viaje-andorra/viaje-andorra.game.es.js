...
undum.game.situations = {
    start: new undum.SimpleSituation(
            "<h1>Viaje a Andorra</h1>\
				<p>Te despiertas un sábado a las 2 del mediodía.</p>",
            {
    ...
    inicio: new undum.SimpleSituation(
        "<p>Lo primero que haces como siempre es mirar cómo va tu canal de youtube</p>\
				<img class='img-situation' src='./media/img/inicio.jpg'>\
        <p>Resulta que ...  \
        <a href='mercadona'>va igual de mal que siempre</a>, o quizás tu video de cómo hacer las mejores croquetas del mundo ha superado el <a href='croquetas'>millón de visitas</a> </p>"
    ...
    mercadona: new undum.SimpleSituation(
        ...
        <img class='img-situation' src='./media/img/fin.jpeg'>\
			<p>Bajas al mercadona a por una pizza y prosigues tu aventura en Youtube, algún día conseguirás tu meta.</p >\
			<h1>Fin</h1>"
            ),

    croquetas: new undum.SimpleSituation(
        "<h1>INCREÍBLE</h1>\
        <p> Tras esta situación, tu reacción instantánea es abrir <a href = 'https://www.idealista.com/alquiler-viviendas/andorra-provincia/'> idealista </a> y encontrar ofertas para comprar un piso en Andorra.</p>\
                <p>Obviamente, también grabas un video de 56s agradeciendo, mientras lloras, el apoyo a tus suscriptores.</p>\
                <p>Posteriormente decides encaminarte destino al paraíso de tus sueños, en busca de la compra tan ansiada, un pisito al lado del casoplón de “ElRubius”.</p>\
    ...
    seat: new undum.SimpleSituation(
        ...
        <p> Llevabas 5 años sin hacerle el mantenimiento al coche por lo que cuando vas a mitad de camino empieza a salir humo y te obliga a detenerte.  </p >\
       <p> Ante este estado no sabes muy bien cómo reaccionar así que al final: \
       <p>terminas llamando a la <a href='grua'>grua</a>, aunque quizás quieras desistir y acercarte a un <a href='burguer'>Burguer King</a>. </p>"
            ),
    ...
    grua: new undum.SimpleSituation(
        ...
        <img class='img-situation' src='./media/img/grua.jpg'>\
			<p>La grua finalmente te llevará de vuelta a casa y no tendrás más remedio que ir al <a href='mercadona'>Mercadona</a>.</p>s"
            ),

    burguer: new undum.SimpleSituation(
            "<h1>BURGUER KING</h1>\
        <img class='img-situation' src='./media/img/burguer.jpg'>\
        			<p>Llegas al Burguer King para comerte una gran hamburguesa después de tu largo caminao, cuando terminas de comértela: \
        <p>Finalmente desistes y vuelves a casa, no sin antes pasarte por el  <a href = 'mercadona' > Mercadona</a >. Sin embargo ves un autobús</p>\
        <p>que tiene la bandera de Andorra, <a href='andorra'>¿deberías montarte?</a></p > s"
            ),
    ...
    finalizar: new undum.SimpleSituation(
            "<h1>Fin de la historia</h1>\
			<p>Otro día más que seguirás sin convertirte en el mejor Youtuber.</p>\
			<h1>Fin</h1>"
            ),
